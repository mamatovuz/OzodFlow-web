...
export const FEATURE_MATRIX: {
  ...
  { label: "Telegram bot + Mini App (menyu)", free: false, starter: false, business: true },
  { label: "Oshxona (kitchen) paneli", free: false, starter: false, business: true },
  { label: "Ofitsant paneli (stol, to'lov)", free: false, starter: false, business: true },
