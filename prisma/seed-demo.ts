...
async function main() {
  ...
  const menu: Record<string, P[]> = {
    Oshlar: [
      ...
      { name: "Nahor oshi", price: 35000, desc: "Ertalabki maxsus osh, sarimsoq va bedana tuxumi bilan", weight: "330g", kcal: 590, img: "1585032226651-759b368d7246", tags: ["new"] },
    ],
    Kaboblar: [
      ...
      { name: "Qovurma kabob", price: 30000, desc: "Piyoz va bulg'or qalampiri bilan qovurilgan", weight: "200g", kcal: 360, img: "1633321088355-d0f81134ca3b", tags: ["recommend"], spicy: 1 },
    ],
    Salatlar: [
      ...
      { name: "Vinegret", price: 18000, desc: "An'anaviy sabzavotli salat", weight: "210g", kcal: 140, img: "1512621776951-a57141f2eefd", tags: ["vegetarian"] },
    ],
    Ichimliklar: [
      ...
      { name: "Kompot", price: 10000, desc: "Uyda tayyorlangan mevali kompot", weight: "0.5L", img: "1613478223719-2ab802602423", tags: ["recommend"] },
    ],
  };
